...
urlpatterns = [
    ...
    url(r'^tasks/(?P<pk>\d+)/submit/$', views.SubmitTaskForVerificationView.as_view(), name='tasks.submit'),
    ...
    url(r'^tasks/attempt/(?P<pk>\d+)/$', views.TaskAttemptDetailView.as_view(), name='tasks.attempt'),
    url(r'^tasks/verification_list/$', views.TaskVerificationListView.as_view(), name='tasks.verification_list'),
