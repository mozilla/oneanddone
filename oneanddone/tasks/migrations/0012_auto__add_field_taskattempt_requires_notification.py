...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskAttempt.requires_notification'
        db.add_column('tasks_taskattempt', 'requires_notification',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskAttempt.requires_notification'
        db.delete_column('tasks_taskattempt', 'requires_notification')
