...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaskMetrics'
        db.create_table('tasks_taskmetrics', (
            ...
            ('abandoned_users', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('closed_users', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('completed_users', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('incomplete_users', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('user_completes_then_completes_another_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('user_completes_then_takes_another_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('user_takes_then_quits_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('tasks', ['TaskMetrics'])


    def backwards(self, orm):
        # Deleting model 'TaskMetrics'
        db.delete_table('tasks_taskmetrics')
