...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.next_task'
        db.add_column('tasks_task', 'next_task',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='previous_task', null=True, to=orm['tasks.Task']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.next_task'
        db.delete_column('tasks_task', 'next_task_id')
