...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Task.allow_multiple_finishes'
        db.delete_column('tasks_task', 'allow_multiple_finishes')


    def backwards(self, orm):
        # Adding field 'Task.allow_multiple_finishes'
        db.add_column('tasks_task', 'allow_multiple_finishes',
