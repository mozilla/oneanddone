...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.team'
        db.alter_column('tasks_task', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['tasks.TaskTeam']))

    def backwards(self, orm):

        # Changing field 'Task.team'
        db.alter_column('tasks_task', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tasks.TaskTeam'], null=True))
