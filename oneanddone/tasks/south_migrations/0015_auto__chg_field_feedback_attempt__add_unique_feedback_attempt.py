...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Feedback.attempt'
        db.alter_column('tasks_feedback', 'attempt_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['tasks.TaskAttempt'], unique=True))
        # Adding unique constraint on 'Feedback', fields ['attempt']
        db.create_unique('tasks_feedback', ['attempt_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Feedback', fields ['attempt']
        db.delete_unique('tasks_feedback', ['attempt_id'])


        # Changing field 'Feedback.attempt'
        db.alter_column('tasks_feedback', 'attempt_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tasks.TaskAttempt']))
