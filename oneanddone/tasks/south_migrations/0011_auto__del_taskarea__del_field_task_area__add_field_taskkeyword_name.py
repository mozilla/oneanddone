...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Task.area'
        db.delete_column('tasks_task', 'area_id')
    ...
    def backwards(self, orm):
        ...
        db.create_table('tasks_taskarea', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(related_name='children', null=True, to=orm['tasks.TaskArea'], blank=True)),
        ...
        # Adding field 'Task.area'
        db.add_column('tasks_task', 'area',
                      self.gf('mptt.fields.TreeForeignKey')(to=orm['tasks.TaskArea'], null=True, blank=True),
                      keep_default=False)
