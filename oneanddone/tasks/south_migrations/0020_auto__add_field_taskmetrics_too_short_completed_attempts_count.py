...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskMetrics.too_short_completed_attempts_count'
        db.add_column('tasks_taskmetrics', 'too_short_completed_attempts_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskMetrics.too_short_completed_attempts_count'
        db.delete_column('tasks_taskmetrics', 'too_short_completed_attempts_count')
