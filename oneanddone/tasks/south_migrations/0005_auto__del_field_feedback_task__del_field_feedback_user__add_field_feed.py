...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Feedback.task'
        db.delete_column('tasks_feedback', 'task_id')

        # Deleting field 'Feedback.user'
        db.delete_column('tasks_feedback', 'user_id')

        # Adding field 'Feedback.attempt'
        db.add_column('tasks_feedback', 'attempt',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tasks.TaskAttempt']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Feedback.task'
        db.add_column('tasks_feedback', 'task',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tasks.Task']),
                      keep_default=False)

        # Adding field 'Feedback.user'
        db.add_column('tasks_feedback', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'Feedback.attempt'
        db.delete_column('tasks_feedback', 'attempt_id')
