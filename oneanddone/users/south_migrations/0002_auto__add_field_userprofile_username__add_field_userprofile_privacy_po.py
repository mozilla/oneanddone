...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('users_userprofile', 'privacy_policy_accepted',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('users_userprofile', 'username')

        # Deleting field 'UserProfile.privacy_policy_accepted'
        db.delete_column('users_userprofile', 'privacy_policy_accepted')
